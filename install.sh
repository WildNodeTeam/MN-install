#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='wildnode.conf'
CONFIGFOLDER='/root/.wildnode/'
COIN_DAEMON='/usr/local/bin/wildnoded'
COIN_CLI='/usr/local/bin/wildnode-cli'
COIN_REPO='https://github.com/WildNodeTeam/WildNodeCore/releases/download/v1.0.0.0/WildNode-Daemon.Ubuntu.v1.0.0.tar.gz'
COIN_NAME='wildnode'
COIN_PORT=30500
RPC_PORT=16020
